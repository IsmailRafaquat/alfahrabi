...
namespace EHub.HealthChecks;

public static class HealthChecksBuilderExtensions
{
    public static void AddEHubHealthChecks(this IServiceCollection services)
    {
        ...
        {
            settings.AddHealthCheckEndpoint("EHub Health Status", configuration["App:HealthUiCheckUrl"] ?? healthCheckUrl);
        });
