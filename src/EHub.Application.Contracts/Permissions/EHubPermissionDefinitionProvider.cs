...
public class EHubPermissionDefinitionProvider : PermissionDefinitionProvider
{
    public override void Define(IPermissionDefinitionContext context)
    {
        ...
        shopAiAssistant.AddChild(EHubPermissions.ShopAiAssistant.QueryMasterData, L("Permission:ShopAiAssistant.QueryMasterData"));
        shopAiAssistant.AddChild(EHubPermissions.ShopAiAssistant.QueryTransactionalData, L("Permission:ShopAiAssistant.QueryTransactionalData"));
        shopAiAssistant.AddChild(EHubPermissions.ShopAiAssistant.QueryUnits, L("Permission:ShopAiAssistant.QueryUnits"));
        shopAiAssistant.AddChild(EHubPermissions.ShopAiAssistant.QueryProductCategories, L("Permission:ShopAiAssistant.QueryProductCategories"));
        shopAiAssistant.AddChild(EHubPermissions.ShopAiAssistant.QueryProducts, L("Permission:ShopAiAssistant.QueryProducts"));
        shopAiAssistant.AddChild(EHubPermissions.ShopAiAssistant.QueryCustomers, L("Permission:ShopAiAssistant.QueryCustomers"));
        shopAiAssistant.AddChild(EHubPermissions.ShopAiAssistant.QuerySuppliers, L("Permission:ShopAiAssistant.QuerySuppliers"));
        shopAiAssistant.AddChild(EHubPermissions.ShopAiAssistant.QueryExpenseCategories, L("Permission:ShopAiAssistant.QueryExpenseCategories"));
        shopAiAssistant.AddChild(EHubPermissions.ShopAiAssistant.QueryBankAccounts, L("Permission:ShopAiAssistant.QueryBankAccounts"));
        shopAiAssistant.AddChild(EHubPermissions.ShopAiAssistant.QueryPurchaseOrders, L("Permission:ShopAiAssistant.QueryPurchaseOrders"));
        shopAiAssistant.AddChild(EHubPermissions.ShopAiAssistant.QueryStockAdjustments, L("Permission:ShopAiAssistant.QueryStockAdjustments"));
        shopAiAssistant.AddChild(EHubPermissions.ShopAiAssistant.QueryPhysicalStockCounts, L("Permission:ShopAiAssistant.QueryPhysicalStockCounts"));
        ...
        shopMcp.AddChild(EHubPermissions.ShopMcp.GetUnits, L("Permission:ShopMcp.GetUnits"));
        shopMcp.AddChild(EHubPermissions.ShopMcp.GetProductCategories, L("Permission:ShopMcp.GetProductCategories"));
        shopMcp.AddChild(EHubPermissions.ShopMcp.GetProducts, L("Permission:ShopMcp.GetProducts"));
        shopMcp.AddChild(EHubPermissions.ShopMcp.GetCustomers, L("Permission:ShopMcp.GetCustomers"));
        shopMcp.AddChild(EHubPermissions.ShopMcp.GetSuppliers, L("Permission:ShopMcp.GetSuppliers"));
        shopMcp.AddChild(EHubPermissions.ShopMcp.GetExpenseCategories, L("Permission:ShopMcp.GetExpenseCategories"));
        shopMcp.AddChild(EHubPermissions.ShopMcp.GetBankAccounts, L("Permission:ShopMcp.GetBankAccounts"));
        shopMcp.AddChild(EHubPermissions.ShopMcp.GetSales, L("Permission:ShopMcp.GetSales"));
        shopMcp.AddChild(EHubPermissions.ShopMcp.GetPurchaseOrders, L("Permission:ShopMcp.GetPurchaseOrders"));
        shopMcp.AddChild(EHubPermissions.ShopMcp.GetExpenses, L("Permission:ShopMcp.GetExpenses"));
        shopMcp.AddChild(EHubPermissions.ShopMcp.GetStockAdjustments, L("Permission:ShopMcp.GetStockAdjustments"));
        shopMcp.AddChild(EHubPermissions.ShopMcp.GetPhysicalStockCounts, L("Permission:ShopMcp.GetPhysicalStockCounts"));
