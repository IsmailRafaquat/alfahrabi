...
public class ShopPurchaseOrderPrintMapper : IShopPrintDocumentMapper
{
    ...
    public ShopPurchaseOrderPrintMapper(
    ...
    public string DocumentType => ShopPrintDocumentTypes.PurchaseOrder;
    ...
    public async Task<ShopPrintDocumentDto> MapAsync(Guid documentId)
    {
        ...
        var entity = query.FirstOrDefault(x => x.Id == documentId && x.TenantId == tenantId)
            ?? throw new EntityNotFoundException(typeof(ShopPurchaseOrder), documentId);
        ...
        return new ShopPrintDocumentDto
        {
            ...
            DocumentNumber = entity.PurchaseOrderNumber,
            DocumentDate = entity.OrderDate,
            Business = business,
            Party = new ShopPrintPartyDto
            {
                ...
                ReferenceNumber = entity.SupplierReference
            },
            ...
            QrCodeValue = (print?.PrintQrCode ?? false) ? entity.PurchaseOrderNumber : null,
            BarcodeValue = (print?.PrintBarcode ?? false) ? entity.PurchaseOrderNumber : null,
