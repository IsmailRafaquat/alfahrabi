  ...
  faqs = [
    {
      ...
      answer: 'Students need to submit their previous academic records, birth certificate, and complete the admission form. An entrance test may be required for certain grades.',
      open: true
    },
    {
